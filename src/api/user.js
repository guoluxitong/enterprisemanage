...
export function getUserList(query) {
  return request({
    url: '/webapi/enterprise/user/list',
    method: 'get',
    params: query
  })
}
export function getUserRole(userId) {
  return request({
    url: '/webapi/enterprise/user/find',
    method: 'get',
    params:{userId}
  })
}
export function changeUserRole(userId,role) {
  return request({
    url: '/webapi/enterprise/user/role/modify',
    method: 'post',
    params:{userId},
    data:role
  })
...
export function editUser(user) {
  return request({
    url: '/webapi/enterprise/user/modify',
    method: 'post',
    data:user
  })
}
...
export function deleteUserById(id) {
  return request({
    url: '/webapi/enterprise/user/remove',
    method: 'post',
