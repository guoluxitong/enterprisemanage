  ...
  <div style="margin-top: 20px" class="app-container product-container">
    <div v-if="PartCategory==0">
      ...
      <!--  <el-col :span="2.5">
        ...
        <el-col :span="2.5">
          <el-input v-model="product.controllerNo" placeholder="锅炉编号" style="width: 130px"></el-input>
        </el-col>
        <el-col :span="2.5">
      ...
      >
        ...
        <el-row v-if="this.titleName=='添加'">
          <el-col :span="24">
            <el-alert
              title="锅炉编号输入警告"
              type="warning"
              description="错误的锅炉编号会引发数据混乱，修正要先删除锅炉信息，后再执行添加。请核实输入是否正确！"
              effect="dark"
              :closable="false"
              show-icon
            ></el-alert>
        ...
        <el-row>
          <el-col v-if="this.titleName=='添加'" :span="12">
            <el-form-item label="锅炉编号">
              <el-input v-model="addFormData.controllerNo" placeholder="锅炉编号"></el-input>
            </el-form-item>
          </el-col>
          <el-col v-if="this.titleName!='添加'" :span="12">
            <el-form-item label="锅炉编号">
              <el-input v-model="addFormData.controllerNo" placeholder="锅炉编号" disabled></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
      ...
      productSearch({
        ...
        if (response.data.code == 0) {
          ...
          for(var i=0;i< this.list.length;i++){
            this.list[i].deviceSuffix=this.replacepos(this.list[i].controllerNo,0,'*****')
          }
